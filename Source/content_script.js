...
function replaceText(v)
{
    ...
    v = v.replace(/\bdilligas\b/ig, 'do I look like I give a ploppers');
    ...
    v = v.replace(/\blmao\b/ig, 'laughing my rear off');
    ...
    v = v.replace(/\bomg\b/ig, "oh my god");
    v = v.replace(/\bfml\b/ig, "jeepers my life");
    v = v.replace(/\bnp\b/ig, "no problem");
    v = v.replace(/\bsmh\b/ig, "shake my head");
    v = v.replace(/\bianal\b/ig, "I am not a lawyer");
    v = v.replace(/\bimo\b/ig, 'in my opinion');
    v = v.replace(/\bhmu\b/ig, 'hit me up');
    v = v.replace(/\bngl\b/ig, 'not gonna lie');
    v = v.replace(/\bgoat\b/ig, 'greatest of all time');
    v = v.replace(/\bsmh\b/ig, 'shaking my head');
